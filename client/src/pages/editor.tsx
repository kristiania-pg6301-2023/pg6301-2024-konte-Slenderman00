...
function Editor() {
  ...
  return (
    <Grid>
      ...
      <ArticleTitleInput value={title} callback={(value: string) => {setTitle(value)}}/>
      <ArticleTextInput value={content} callback={(value: string) => {setContent(value)}}/>
      <ArticleCategoryInput value={category} callback={(value: string) => {setCategory(value)}}>
      ...
      <ArticleTitleInput value={image} callback={(value: string) => {setImage(value)}}/>
      <ArticleSubmit callback={() => {
        if(id == 'new') {
