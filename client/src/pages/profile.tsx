...
import { GenericInput, GenericInputLarge, GenericSubmit } from "./components/inputs";
        ...
        <div className="editProfileBox">
            <div className="internal">
                ...
                <div className="textInputs">
                    ...
                    <GenericInputLarge value={user.bio} callback={(result: any) => {
                        setUser(prevUser => ({ ...prevUser, bio: result }));
                    }}/>
                    <GenericInput value={user.picture} callback={(result: any) => {
                        setUser(prevUser => ({ ...prevUser, picture: result }));
                    }}/>
                    <GenericSubmit callback={() => {
